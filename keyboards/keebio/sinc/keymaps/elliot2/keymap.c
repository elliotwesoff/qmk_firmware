...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_80_iso_with_macro(
    ...
    LGUI(KC_Z),      M1,         KC_GRV,     KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  _______, KC_BSPC,      KC_HOME,
    LGUI(KC_7),      LGUI(KC_8), KC_TAB,     KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC,                        KC_END,
  ...
  [1] = LAYOUT_80_iso_with_macro(
    ...
    RGB_HUI, RGB_HUD, KC_ESC, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_DELETE, _______,
    ...
    RGB_VAI, RGB_VAD, KC_CAPS, _______, KC_LEFT, KC_DOWN, KC_RGHT, _______, KC_HOME, _______, _______, KC_END,  _______, _______, _______, _______,            _______,
