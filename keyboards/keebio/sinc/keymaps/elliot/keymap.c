...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_80_with_macro(
    ...
    LGUI(KC_1), LGUI(KC_2),           TG(2),   KC_LALT, KC_LGUI, KC_LGUI, _______, MO(1),            XXXXXXX, KC_SPC,  KC_RGUI, KC_RALT, KC_RCTL, KC_LEFT,          KC_DOWN,      KC_RGHT
  ),
  [1] = LAYOUT_80_with_macro(
    ...
    M5, M6,     _______, _______, _______, _______, _______, _______, KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT, _______, _______,          _______, _______,
...
bool rgb_matrix_indicators_advanced_user(uint8_t led_min, uint8_t led_max) {
  ...
  switch(get_highest_layer(layer_state|default_layer_state)) {
    case 2:
      rgb_matrix_set_color(led_min + 2, RGB_BLUE); // F1
      break;
    case 1:
      rgb_matrix_set_color(led_min + 3, RGB_YELLOW); // F2
      break;
    default:
      break;
  }
