...
enum custom_keycodes {
  WAT, M1, M2, M3, M4, M5, M6, M7, M8, M9, M10
};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_80_iso_with_macro(
    ...
    LGUI(KC_1), LGUI(KC_2),           KC_LCTL,    KC_LALT, KC_LGUI, KC_LGUI, _______, KC_LCTL,          _______, KC_SPC,  KC_RALT, KC_RGUI, KC_RCTL, KC_LEFT,          KC_DOWN,      KC_RGHT
  ),
  [1] = LAYOUT_80_iso_with_macro(
    ...
    M7, M8,                       BL_TOGG, _______, _______, _______, _______, _______, _______, _______, _______, _______,  _______, _______, _______,                     _______,
    M5, M6,                       KC_CAPS, _______, _______, _______, _______, _______, KC_LEFT, KC_DOWN, KC_UP  , KC_RIGHT, _______, _______, _______, _______,            _______,
